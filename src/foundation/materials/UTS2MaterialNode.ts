  ...
  constructor(isOutline: boolean, materialPropertiesArray: any, textures: any, isMorphing: boolean, isSkinning: boolean, isLighting: boolean) {
    ...
    shaderSemanticsInfoArray.push(

      {
        ...
        initialValue: new Scalar(this.__floatPropertiesArray[0]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[2]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[4]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._Use_1stAs2nd, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[5]), min: 0, max: 1,
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[6]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[8]), min: 0, max: 1,
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[9]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[13]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[21]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[30]), min: 0, max: 1,
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[31]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[42]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._1st_ShadeColor_Step, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[43]), min: 0, max: 1,
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[44]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._2nd_ShadeColor_Step, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[45]), min: 0, max: 1,
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[46]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._StepOffset, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[47]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[51]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[55]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._Ap_RimLight_Power, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[56]), min: 0, max: 1,
      },
      {
      ...
      },
      {
        ...
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[62]), min: 0, max: 1,
      },
      {
        semantic: UTS2MaterialNode._TweakMatCapOnShadow, componentType: ComponentType.Float, compositionType: CompositionType.Scalar,
        stage: ShaderType.PixelShader, isSystem: false, updateInteval: ShaderVariableUpdateInterval.EveryTime,
        initialValue: new Scalar(this.__floatPropertiesArray[63]), min: 0, max: 1,
      },
      {
