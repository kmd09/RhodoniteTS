...
export default class MutableQuaternion extends Quaternion implements IVector4 {
  ...
  rotateX(rad: number) {
    ...
    this.x = tmpX * cos + tmpW * sin;
    this.y = tmpY * cos + tmpZ * sin;
    this.z = tmpZ * cos - tmpY * sin;
    this.w = tmpW * cos - tmpX * sin;
  ...
  rotateY(rad: number) {
    ...
    this.x = tmpX * cos - tmpZ * sin;
    this.y = tmpY * cos + tmpW * sin;
    this.z = tmpZ * cos + tmpX * sin;
    this.w = tmpW * cos - tmpY * sin;
  ...
  rotateZ(rad: number) {
    ...
    this.z = tmpZ * cos + tmpZ * sin;
    this.w = tmpW * cos - tmpW * sin;
